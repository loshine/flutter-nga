...
mixin _$UserRepliesStore on _UserRepliesStore, Store {
  final _$stateAtom = Atom(name: '_UserRepliesStore.state');
  ...
  final _$refreshAsyncAction = AsyncAction('_UserRepliesStore.refresh');
  ...
  final _$loadMoreAsyncAction = AsyncAction('_UserRepliesStore.loadMore');
