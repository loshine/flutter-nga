...
mixin _$ForumTagListStore on _ForumTagListStore, Store {
  late final _$tagListAtom =
      Atom(name: '_ForumTagListStore.tagList', context: context);
  ...
  late final _$loadAsyncAction =
      AsyncAction('_ForumTagListStore.load', context: context);
  ...
  late final _$_ForumTagListStoreActionController =
      ActionController(name: '_ForumTagListStore', context: context);
