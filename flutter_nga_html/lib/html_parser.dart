...
typedef CustomRender = Widget Function(dom.Node node, List<Widget> children,
    NodeParser nodeParser, NodesParser nodesParser);
typedef OnLinkTap = void Function(String url);
typedef NodeParser = Widget Function(dom.Node node);
typedef NodesParser = List<Widget> Function(List<dom.Node> nodeList);
  ...
  Widget _parseNode(dom.Node node) {
    if (customRender != null) {
      final Widget customWidget = customRender(
          node, _parseNodeList(node.nodes), _parseNode, _parseNodeList);
